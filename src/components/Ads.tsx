...
export function Ads() {
    ...
    return (
        <div className="bg-accent/70  overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div className="relative p-4 w-full max-w-2xl max-h-full">
                <div className="bg-foreground dark:bg-background rounded-lg border shadow-sm w-full">
                    ...
                    <div className="px-6">
                        <p className="text-lg text-primary-foreground dark:text-white">
