...
Demo Here: [click here](https://b95nf.csb.app/)

<iframe width="928" height="500" src="https://codesandbox.io/embed/react-quiz-app-b95nf?from-embed" style=" height:500px; border:0; border-radius: 4px; overflow:hidden;" sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin"></iframe>
...
Header component we return a simple h1 tag for the app title. {.info}
