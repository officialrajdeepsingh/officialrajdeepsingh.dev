...
description : In ghost CMS, There are many ways to add search bar functionality in ghost CMS. But most commonly use Googles custom search tool to add a search bar.
draft: false
