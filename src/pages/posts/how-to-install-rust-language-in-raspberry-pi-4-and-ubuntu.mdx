...
date: 2022-03-17T07:05:24.000Z
description: Install the Rust language in the Linux distros.
image: /images/post/2022/03/install-Rust-langauge.png
tags:
  - Rust
  - Linux
  - Raspberry pi 4
...
draft: false
lastmod: 2023-03-09T15:04:49.437Z
author: Rajdeep Singh
type : post
---

Installation of Rust in raspberry pi 4 and Ubuntu is a very easy process for all
Linux distros. You can install Rust with one single command. So simple, you copy
...
After you paste the command in a terminal, the rust setup asks one question to
start the installation rust in your distro.
...
At the End of the step, you just `source $HOME/.cargo/env` and paste the
following command into the terminal. This command help to set up your current
shell in your machine. So you can run rust in your current terminal or shell
without restarting your machine.

### How to delete or uninstall the rust lang?

You can uninstall the Rust with rustup. rustup in in-build command utility in
rust lang.
...
I hope my article solves your problem. If you have any queries, then ask in the
comment section.
