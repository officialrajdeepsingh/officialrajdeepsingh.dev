...
The new version of the subline comes with utilizing GPU's support Linux, Mac, and Windows. Sublime also supports Apple Silicon processors, Linux ARM64
architecture, and Raspberry pi 4. 
...
Now Ubuntu is an official support snap store Linux packages manager. With the snap package manager, you install tons of packages locally in your distro. Snap
...
Note Only remove the sublime-text command when your install sublime-text editor with snap command.
</Alert>
