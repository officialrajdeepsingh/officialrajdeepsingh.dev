...
expect: Remove Software inside Your Raspberry 4 with three copy & paste  Commands.
draft: false
...
<Alert color="blue">
Next, we will remove any unnecessary packages that have
been installed as dependencies for the software we no longer have used to this.
