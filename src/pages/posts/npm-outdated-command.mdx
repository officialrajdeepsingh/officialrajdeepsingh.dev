...
expect: Npm outdate command help to find old packages in your current project.
image: /images/npm-commands.png
tags:
  - Npm command
  - NPM CLI
  - Npm
title: Learn about the NPM outdated package command?
draft: true
author: Rajdeep Singh
lastmod: 2023-03-09T15:07:41.442Z
type : post
---

Npm outdated command print the list of the outdated package in your project. In
the project, there are a lot of packages to check which are outdated.
...
In manual ways, you open `package.json` files and compare every package
manually.

## NPM command

Npm, provide inbuilt functionality for the outdated package. So simple, you run
one npm command, and you get a list of all npm outdated packages in your
terminal.
...
The list of options we discuss in the articles is common, and everybody uses
them daily.

## --all or -a

-all flags or options help print all the outdated packages. The list is based
on your project increase or decrease. For an indication -all flags use colour.
...
--json print the data in the terminal in json structure. It helps to visualize
and debug the packages.json file more easily.

```json
rajdeepsingh@officialrajdeepsingh:~/Downloads/officialstaticblog$ npm outdated --json
{
...
```bash
rajdeepsingh@officialrajdeepsingh:~/Downloads/officialstaticblog$ npm outdated -l
...
The global flag help print all the global package currently installed on your
machine or laptop.
