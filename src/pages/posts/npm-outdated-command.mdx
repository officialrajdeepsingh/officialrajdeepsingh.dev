...
Npm, provide inbuilt functionality for the outdated package. So simple, you run one npm command, and you get a list of all npm outdated packages in your
terminal.
...
--json print the data in the terminal in json structure. It helps to visualize and debug the packages.json file more easily.
