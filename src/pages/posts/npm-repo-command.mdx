...
npm repo command help to open the npm package repository page in your default browser. npm repo is the easiest command in npm, and the syntax vice is very
easy and rememberable.

npm repo is a most usable and helpful command. We often open the package repository home page, and sometimes we do not know which is the repository page.
So we go online and spend a lot of time finding the repository page. 
