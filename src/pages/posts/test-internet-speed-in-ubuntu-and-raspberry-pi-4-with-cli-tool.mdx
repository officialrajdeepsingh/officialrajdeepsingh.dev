...
expect: You use Google to check whether the internet is working or not. Right now your life is changing you run a simple command to check internet speed on Ubuntu and Raspberry pi 4.
draft: false
