...
The new version of the create-tauri-app has removed the nextjs and other frontend library support like preact, preact-ts, clojurescript, svelte-kit, and svelte-kit-ts templates. {.info}
